  ...
  const rules = [
    {
      ...
      description:
        "Peças podem ser alugadas por 1 a 7 dias, com possibilidade de extensão mediante disponibilidade.",
    ...
    },
    {
      ...
      description:
        "Entregamos em toda a região metropolitana ou você pode retirar em nossa loja física.",
      details: [
    ...
    },
    {
      ...
      description:
        "Todas as peças são higienizadas antes e após cada uso com produtos especializados.",
      details: [
    ...
    },
    {
      ...
      description:
        "Aceitamos PIX, cartão de crédito/débito. Pagamento antecipado obrigatório.",
      details: [
        "PIX com desconto",
    ...
    },
    {
      ...
      description:
        "Todas as roupas devem ser devolvidas nas mesmas condições de retirada.",
      details: [
    ...
    },
    {
      ...
      description:
        "Em caso de danos irreversíveis, será cobrado o valor de reposição da peça.",
      details: [
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-montserrat text-lg text-muted-foreground max-w-2xl mx-auto">
            Conheça nossas políticas para garantir uma experiência transparente
            e segura para todos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-fade-in">
          {rules.map((rule, index) => (
            ...
            >
              {/* Icon */}
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full  text-primary mb-6 group-hover:scale-110 transition-transform duration-300">
                {rule.icon}
              </div>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-gradient-gold-subtle border border-primary/20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="font-montserrat text-muted-foreground mb-6">
              ...
              questão sobre o processo de aluguel. Entre em contato conosco pelo
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() =>
                  window.open(
                    "https://wa.me/5511999999999?text=Olá! Tenho dúvidas sobre as regras de aluguel.",
                    "_blank"
                  )
                }
